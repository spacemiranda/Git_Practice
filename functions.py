...
def testall():
    ...
    print(split_this_string_at_each_space('split this on spaces'))
    print(take_the_average_of_these_numbers(10, 20))
    #print_the_time_now_using_astropy()
    print(return_the_minimum_of_two_numbers(10, 20))
    print(return_the_std_of_two_numbers(10, 20))
    hello_world()
